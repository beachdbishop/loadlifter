				...
				<div class="mt-4 ll-page-grid  |  md:gap-8 md:mt-8 md:grid md:auto-rows-auto lg:mt-16 lg:gap-16">
							...
							<section class="full-bleed not-prose ll-equal-vert-padding bg-repeat  |  print:hidden"
								...
								<div class="post-grid  |  px-2  |  lg:px-4">
									<div class="flex items-center justify-between mb-4">
										<h2>Insights</h2>
										<a href="/blog/" class="font-head font-semibold   |  ">View	All <i class="fa-regular fa-angle-right"></i></a>
									</div>
									<?php
					...
					<div class="ll-page-grid-area-c">
						...
						<?php if ( ( $page_post_category ) && ( $resourcesQuery->have_posts() ) ) :
							echo '<div class="prose space-y-4 pb-8  |  lg:pb-0">';
							echo '<h4>Related Resources</h4>';
							echo '<ul class="text-base" data-cat="' . $page_post_category->slug . '">';
