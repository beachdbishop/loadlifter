					...
					<div class="grid gap-16  |  lg:grid-cols-2">
						...
						<div class="bg-white/70 text-orient-900 rounded-3xl p-8  |  lg:p-12 lg:rounded-[3rem]">
							...
							<ul class="list-none mt-4 grid grid-cols-1 gap-8 ">
								<li class="person-card card-i @container">
									<div class="flex flex-col @2xs:flex-row gap-2 items-center h-full  |  md:gap-4">
										...
										<div class="card-img  |  shrink-0 object-cover object-center rounded-full border-3 border-orient-800 bg-neutral-100 bg-no-repeat bg-[center_top]" style="background-image: url('https://beachfleischman.com/wp-content/uploads/2022/10/bio_rect-beto.jpg'); background-size: 128px 171px;"><div class="size-32 aspect-square">&nbsp;</div></div>
									</div>
								</li>
								<li class="person-card card-i @container">
									<div class="flex flex-col @2xs:flex-row gap-2 items-center h-full  |  md:gap-4">
										...
										<div class="card-img  |  shrink-0 object-cover object-center rounded-full border-3 border-orient-800 bg-neutral-100 bg-no-repeat bg-[center_top]" style="background-image: url('https://beachfleischman.com/wp-content/uploads/2022/10/bio_rect-culibarri.jpg'); background-size: 128px 171px;"><div class="size-32 aspect-square">&nbsp;</div></div>
									</div>
								</li>
								<li class="person-card card-i @container">
									<div class="flex flex-col @2xs:flex-row gap-2 items-center h-full  |  md:gap-4">
										...
										<div class="card-img  |  shrink-0 object-cover object-center rounded-full border-3 border-orient-800 bg-neutral-100 bg-no-repeat bg-[center_top]" style="background-image: url('https://beachfleischman.com/wp-content/uploads/2023/02/bio_rect-lpierson.jpg'); background-size: 128px 171px;"><div class="size-32 aspect-square">&nbsp;</div></div>
									</div>
								</li>
							</ul>
						</div>
