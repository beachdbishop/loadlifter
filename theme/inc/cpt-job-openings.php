...
if ( ! function_exists( 'll_make_bfco_job_opening' ) ) {
	...
	function ll_make_bfco_job_opening() {
		...
		$rewrite = array(
			'slug'                  => 'career-opportunities/job-openings',
			'with_front'            => true,
			'pages'                 => false,
			'feeds'                 => true,
		);
		$args = array(
			...
			'template'				=> array(
				array( 'core/paragraph', array(
					'placeholder'		=> 'Add position intro...',
				) ),
				array( 'core/heading', array(
					'level' 			=> 3,
					'content'			=> 'Essential Duties and Responsiblities'
				) ),
				array( 'core/list' ),
				array( 'core/heading', array(
					'level' 			=> 3,
