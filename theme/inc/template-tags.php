...
if ( ! function_exists( 'll_page_hero' ) ) :
    function ll_page_hero( $h1, $h2, $img ) {
        ...
        echo '<div class="page-hero | ll-equal-vert-padding bg-brand-blue-dark bg-no-repeat bg-[right_33%_center] bg-cover lg:bg-center print:py-8" style="background-image: ' . $easedGradient . ', url(' . $bg . ');" itemprop="image" itemscope itemtype="https://schema.org/ImageObject" role="img" aria-label="">
