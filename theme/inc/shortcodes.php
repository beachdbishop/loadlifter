...
function ll_awardlogos_shortcode() {
	return '<div class="awards-wrap  |  not-prose flex flex-wrap items-center gap-8 my-8 justify-center md:justify-start lg:justify-evenly lg:gap-x-16">
		...
		<a href="https://accountingmoveproject.com/" target="_blank" rel="noreferrer noopener"><img loading="lazy" src="https://res.cloudinary.com/beachfleischman/image/upload/c_scale,dpr_auto,f_auto,h_200/v1729893609/2024_Best_Firm_for_Equity_Leadership_Accounting_MOVE_Project_Badge_ennzjc.png" width="161" height="100" alt="2024 Best Firm for Equity Leadership - Accounting MOVE Project"></a>
		<a href="https://accountingmoveproject.com/" target="_blank" rel="noreferrer noopener"><img loading="lazy" src="https://res.cloudinary.com/beachfleischman/image/upload/c_scale,dpr_auto,f_auto,h_200/v1730746122/MOVE_for_women_badge_l8hv8z.png" alt="2024 Best Firm for Women - Accounting MOVE Project" width="161" height="100"></a>
