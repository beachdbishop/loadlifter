...
function ll_awardlogos_shortcode() {
	...
	return '<div class="awards-wrap  |  not-prose flex flex-wrap gap-8 items-center my-8 justify-start place-content-evenly  |  ">
		<a href="https://www.bizjournals.com/phoenix/subscriber-only/2024/05/17/largest-phoenix-area-accounting-firms.html" target="_blank" rel="noreferrer noopener">
			<img loading="lazy" src="https://res.cloudinary.com/beachfleischman/image/upload/c_scale,dpr_auto,f_auto,h_200,q_auto/v1717027280/2024_pbj_largest-phx-acct-firms_nyik4u.png" alt="2024 4th Largest Phoenix-Area Accounting Firms - Phoenix Business Journal" width="102" height="100">
		</a>
		<a href="https://insidepublicaccounting.com/" target="_blank" rel="noreferrer noopener">
			<img loading="lazy" src="https://res.cloudinary.com/beachfleischman/image/upload/c_scale,dpr_auto,f_auto,h_200,q_auto/v1738626316/IPA_-_Award_Logo_-_Top_200_Firms_cvl1wy.png" alt="2024 Top 200 Firms - Inside Public Accounting" width="100" height="100">
		</a>
		<a href="https://bestcompaniesgroup.com/programs/inclusive-workplace-program/" target="_blank" rel="noreferrer noopener">
			<img loading="lazy" src="https://res.cloudinary.com/beachfleischman/image/upload/c_scale,dpr_auto,f_auto,h_200/v1722882083/Inclusive_Workplace_July_24-July_25-c_pmft9t.png" alt="July 2024-July 2025 Inclusive Workplace - Best Companies Group" width="100" height="100">
		</a>
		<a href="https://accountingmoveproject.com/" target="_blank" rel="noreferrer noopener">
			<img loading="lazy" src="https://res.cloudinary.com/beachfleischman/image/upload/c_scale,dpr_auto,f_auto,h_200/v1729893609/2024_Best_Firm_for_Equity_Leadership_Accounting_MOVE_Project_Badge_ennzjc.png" width="161" height="100" alt="2024 Best Firm for Equity Leadership - Accounting MOVE Project">
		</a>
		<a href="https://accountingmoveproject.com/" target="_blank" rel="noreferrer noopener">
			<img loading="lazy" src="https://res.cloudinary.com/beachfleischman/image/upload/c_scale,dpr_auto,f_auto,h_200/v1730746122/MOVE_for_women_badge_l8hv8z.png" alt="2024 Best Firm for Women - Accounting MOVE Project" width="161" height="100">
		</a>
		<a href="https://www.accountingtoday.com/" target="_blank" rel="noreferrer noopener">
			<img loading="lazy" src="https://res.cloudinary.com/beachfleischman/image/upload/c_scale,dpr_auto,f_auto,h_200/v1723737229/2024_Accounting_Todays_Best_Firms_to_Work_For_Logo_File_tua6sz.png" alt="2024 Best Firms to Work For" width="198" height="100">
		</a>
		<a href="https://insidepublicaccounting.com/" target="_blank" rel="noreferrer noopener">
			<img loading="lazy" src="https://res.cloudinary.com/beachfleischman/image/upload/c_scale,dpr_auto,f_auto,h_100/v1634657713/award__ipa-all-star-firms_ium0vb.png" alt="All Star Firms - Inside Public Accounting" width="100" height="100">
		</a>
		<a href="https://www.cigna.com/employers/insights/measuring-up-in-wellness" target="_blank" rel="noreferrer noopener">
			<img loading="lazy" src="https://res.cloudinary.com/beachfleischman/image/upload/c_scale,dpr_auto,f_auto,h_200/v1707756234/cigna-healthy-workforce-desigation-2023_oo3u47.png" alt="Cigna Healthy Workforce Designation 2023 - Silver" width="91" height="100">
		</a>
	</div>';
}
...
function ll_constrassoclogos_shortcode() {
	return '<div class="flex flex-col flex-wrap items-center gap-8 my-8 place-content-center  |  md:place-content-start md:flex-row lg:gap-x-16">
		<a
			href="https://actaz.net/"
			target="_blank"
		>
			<img
				loading="lazy"
				src="https://res.cloudinary.com/beachfleischman/image/upload/f_auto/v1679441728/ACT_sfb9d9.png"
				alt="logo: Alliance of Construction Trades (ACT)" title="Alliance of Construction Trades (ACT)"
				width="166"
				height="70"
			>
		</a>
		<a
			href="https://asa-az.org/"
			target="_blank"
		>
			<img
				loading="lazy"
				src="https://res.cloudinary.com/beachfleischman/image/upload/dpr_auto,f_auto/v1697479496/ASAA_cboctk.png"
				alt="logo: American Subcontractors Association of Arizona (ASA)" title="American Subcontractors Association of Arizona (ASA)"
				width="112"
				height="70"
			>
		</a>
		<a
			href="https://www.azbuilders.org/"
			target="_blank"
		>
			<img
				loading="lazy"
				src="https://res.cloudinary.com/beachfleischman/image/upload/f_auto/v1679440947/ABA_fuftwq.png"
				alt="logo: Arizona Builders Alliance (ABA)" title="Arizona Builders Alliance (ABA)"
				width="88"
				height="70"
			>
		</a>
		<a
			href="https://www.azagc.org/"
			target="_blank"
		>
			<img
				loading="lazy"
				src="https://res.cloudinary.com/beachfleischman/image/upload/dpr_auto,f_auto/v1679609834/assclogo--azagc_seoaiv.png"
				alt="logo: Arizona Chapter of the Associated General Contractors of America (AZAGC)" title="Arizona Chapter of the Associated General Contractors of America (AZAGC)"
				width="188"
				height="70"
			>
		</a>
		...
		>
			<img
				loading="lazy"
				src="https://res.cloudinary.com/beachfleischman/image/upload/f_auto/v1679441643/ABC_sxlwvt.png"
				alt="logo: Associated Builders and Contractors, Inc. (ABC)" title="Associated Builders and Contractors, Inc. (ABC)"
				width="123"
				height="70"
			>
		</a>
		<a
			href="https://cicpac.com/"
			target="_blank"
		>
			<img
				loading="lazy"
				src="https://res.cloudinary.com/beachfleischman/image/upload/f_auto/v1679450546/CICPAC_irfutw.png"
				alt="logo: Construction Industry CPAs/Consultants Association (CICPAC)" title="Construction Industry CPAs/Consultants Association (CICPAC)"
				width="246"
				height="70"
			>
		</a>
		...
		>
			<img
				loading="lazy"
				src="https://res.cloudinary.com/beachfleischman/image/upload/f_auto/v1679450494/CFMA_ixqdim.png"
				alt="logo: Construction Financial Management Association (CFMA)" title="Construction Financial Management Association (CFMA)"
				width="184"
				height="70"
			>
		</a>
		<a
			href="https://www.nawic.org/"
			target="_blank"
		>
			<img
				loading="lazy"
				src="https://res.cloudinary.com/beachfleischman/image/upload/f_auto/v1679450575/NAWIC_zktjka.png"
				alt="logo: National Association of Women In Construction (NAWIC)" title="National Association of Women In Construction (NAWIC)"
				width="169"
				height="70"
			>
		</a>
...
function ll_cybercertlogos_shortcode() {
	return '<div class="not-prose flex flex-wrap items-center gap-8 justify-start place-content-evenly">
