...
<form action="/" method="get" class="flex flex-wrap w-full gap-2 md:gap-4 lg:gap-6">
	<label class="relative block p-3 bg-white border-2 rounded-lg grow border-neutral-200" for="search">
		<input class="w-full grow px-0 pt-3.5 pb-0 text-sm placeholder-transparent border-none focus:ring-0 peer" type="text" name="s" id="search" placeholder="Search" value="<?php the_search_query(); ?>" />
