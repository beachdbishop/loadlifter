...
<header role="banner" id="masthead" class="bg-white print:bg-white print:shadow-none sticky top-0 z-[39] ">
	<nav role="navigation" class="flex items-center justify-between px-1 py-3 mx-auto md:container md:px-0 xlg:px-8 ">
		...
		<details-utils role="menu" class="nav-primary |  print:hidden" force-open="(min-width: 48em)" force-restore close-click-outside close-esc animate>
			<details role="menuitem" aria-haspopup="true" class="hoverable | group hover:bg-white">
				<summary><a href="#" class="relative block px-3 py-4 font-bold font-head lg:p-6 hover:text-brand-red">Services</a></summary>
				<div class="nav__panel--services | z-40 mb-16 border-t border-solid shadow-xl border-neutral-800 sm:mb-0">
			...
			<details role="menuitem" aria-haspopup="true" class="hoverable | group hover:bg-white">
				<summary><a href="/industries/" class="relative block px-3 py-4 font-bold font-head lg:p-6 hover:text-brand-red">Industries</a></summary>
			...
			<details role="menuitem" aria-haspopup="true" class="hoverable | group  hover:bg-white">
				<summary><a href="/blog/" aria-label="Get the latest blog posts, events, etc." aria-haspopup="true" class="relative block px-3 py-4 font-bold font-head lg:p-6 hover:text-brand-red">Insights</a></summary>
			...
			<details role="menuitem" aria-haspopup="true" class="hoverable | group hover:bg-white">
				<summary><a href="/about-us/" class="relative block px-3 py-4 font-bold font-head lg:p-6 hover:text-brand-red">About</a></summary>
				<div class="nav__panel--services | z-40 mb-16 border-t border-solid shadow-xl border-neutral-800 mega-menu sm:mb-0">
					<div class="container grid grid-flow-col grid-cols-3 mx-auto">
						<div class="hidden p-4 lg:block bg-brand-blue-faint on-lightbg lg:p-8 ">
			...
			<details role="menuitem" aria-haspopup="true" class="hoverable | group hover:bg-white">
				<summary><a href="/careers/" class="relative block px-3 py-4 font-bold font-head lg:p-6 hover:text-brand-red">Careers</a></summary>
				<div class="nav__panel--services | z-40 mb-16 border-t border-solid shadow-xl border-neutral-800 mega-menu sm:mb-0">
					<div class="container grid grid-flow-col grid-cols-3 mx-auto">
						<div class="hidden p-4 lg:block bg-brand-blue-faint on-lightbg lg:p-8 ">
			...
			<div role="menuitem" aria-haspopup="false" class="hoverable | group hover:bg-white">
				<a href="/client-center/" class="relative block px-3 py-4 font-bold font-head lg:p-6 hover:text-brand-blue">Client Center</a>
			</div>

			<div role="menuitem" aria-haspopup="false" class="hoverable | group hover:bg-white">
				<a href="/contact/" class="relative block px-3 py-4 font-bold font-head lg:p-6 hover:text-brand-blue">Contact</a>
			</div>

			<details role="menuitem" aria-haspopup="true" class="toggleable | group hover:bg-white ">
				<summary class="block px-6 py-4 text-sm font-bold cursor-pointer lg:text-base lg:py-6 hover:text-brand-red peer-checked:text-brand-red peer-checked:bg-white" aria-label="Toggle Search">
					<i class="fa-solid fa-magnifying-glass"></i>
				</summary>
				<div class="z-40 py-2 mb-16 border-t border-solid shadow-xl md:py-4 border-brand-blue lg:py-6 sm:mb-0 bg-brand-gray-dark ">
