...
<header id="masthead" class="nav-header | bg-white sticky top-0 z-[39] dark:bg-neutral-900 dark:text-neutral-100 print:relative print:bg-white print:shadow-none">
