...
<header role="banner" id="masthead" class="nav-header | bg-white print:bg-white print:shadow-none sticky top-0 z-[39] ">
	<div role="navigation" class="flex items-center justify-between px-1 py-3 mx-auto md:container md:px-0 md:py-4">
		...
		<nav class="menus-container med-and-up | hidden md:flex md:flex-col md:order-1 lg:min-w-[600px] print:hidden" id="primary-navigation" aria-label="Primary">
					...
					<details class="relative block group menu-level-0">
						...
						<div class="details-drop nav__panel--4col-trans | ">
							<div class="container md:mx-auto md:grid md:grid-flow-col md:grid-cols-4">
								...
								<div class="py-4 md:grid md:grid-flow-col md:col-span-3 on-darkbg lg:py-8 md:auto-cols-fr">
			...
			<ul role="menu" class="nav-secondary | md: md:order-first md:justify-end md:flex print:hidden">
				<li role="menuitem">
					<a class="relative block px-3 pt-3 pb-1 text-sm font-bold md:uppercase text-neutral-500 hover:text-brand-red-dark" href="/scratch/">Scratch</a>
				</li>
				<li role="menuitem">
				...
				<li role="menuitem">
					<a class="relative block px-3 pt-3 pb-1 text-sm font-bold md:uppercase text-neutral-500 hover:text-brand-red-dark" href="#">Contact Us</a>
				</li>
			</ul>
		</nav>
