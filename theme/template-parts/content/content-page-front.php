...
<div class="ind-feat-image | py-8 md:py-12 lg:py-20 bg-brand-blue-dark bg-center bg-cover" style="background-image: <?php echo $gradient; ?>, url('<?php echo esc_url( $featimg[0] ); ?>');" itemprop="image" itemscope itemtype="https://schema.org/ImageObject" role="image" aria-label="<?php esc_attr_e( get_the_title(), 'loadlifter' ); ?>">
...
<section class="py-4 mb-0 bg-gradient-to-br from-brand-blue to-brand-blue-dark md:py-8 2xl:py-12">
	<div class="px-2 md:px-0 md:container md:mx-auto">
...
<div class="px-2 my-4 md:my-8 md:px-0 md:container md:mx-auto ">
	...
	<?php echo do_shortcode( '[display-posts posts_per_page="3" ignore_sticky_posts="true" orderby="date" order="DESC" wrapper="div" wrapper_class="flex flex-wrap -mx-4" layout="card" /]' ); ?>
	<div class="wp-block-buttons | text-center my-4">
		<div class="wp-block-button is-style-outline">
