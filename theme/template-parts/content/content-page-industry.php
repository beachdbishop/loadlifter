...
$ind_id = get_the_ID();
$ind_icon = get_field( 'll_page_icon' );
$ind_message = get_field( 'll_brand_message' );
// $ind_message = get_field_object( 'll_brand_message' );
// $ind_message_val = $ind_message['value'];
// $ind_message_label = $ind_message['choices'][ $ind_message_val ];
