...
<article id="post-<?php the_ID(); ?>" <?php post_class( 'post-card | p-4 mb-4 ' ); ?>>
	...
	<div class="">
		...
		<header>
			<?php the_title( '<h3 class="my-2 overflow-hidden leading-tight tracking-wide break-words text-brand-blue-faint text-ellipsis"><a href="' . esc_url( get_permalink() ) . '" rel="bookmark">', '</a></h3>' ); ?>
		</header>
		<div class="text-sm ">
			<?php the_excerpt(); ?>
		</div>
