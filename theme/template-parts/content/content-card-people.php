...
<article id="post-<?php the_ID(); ?>" <?php post_class( 'person-card | p-4 mb-4 group' ); ?>>
	<div class="card-headshot | mx-auto mb-2 md:mb-4 rounded-full bg-brand-red-faint bg-top bg-cover grayscale-[60%] group-hover:grayscale-0" style="background-image: url('<?php echo $headshot; ?>');">
