	...
	<div class="px-2  |  md:container lg:px-4">
		...
		<div class="peepgrid peep-<?php echo $peep_class; ?> peep-<?php echo esc_attr( $peep_level['value'] ); ?>  |  md:grid md:grid-cols-3 gap-4 lg:grid-cols-4 lg:gap-16">
			...
			<div class="peepgrid-a  |  pb-8 md:pt-2 md:pb-0 md:order-2">
				...
				?>
				<div class="headshot-wrapper  |  relative  |  md:before:content-[''] md:before:absolute md:before:top-2 md:before:left-2 md:before:w-full md:before:h-full md:before:bg-neutral-200 dark:md:before:bg-neutral-600 print:before:bg-none">
...
<?php if ( $peepRecentPostsCount > 0 ) : ?>
	<section id="posts-by-<?php the_ID(); ?>" <?php post_class( 'bg-neutral-100 ll-equal-vert-padding  dark:bg-neutral-950' ); ?>>
		<div class="px-2  |  md:container lg:px-4">
			<h3 id="posts" class="mt-2 mb-4 text-4xl text-brand-blue head-last-bold  |  md:mb-8 dark:text-neutral-300">Recent Insights by <strong><?php echo $person_archivelink; ?></strong></h3>
