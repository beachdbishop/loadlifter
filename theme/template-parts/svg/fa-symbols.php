<?php
/**
 * Font Awesome icons that are used frequently enough to make symbols
 *
...
<i data-fa-symbol="caret-left" class="fa-regular fa-caret-left"></i>
<i data-fa-symbol="angle-up" class="fa-regular fa-angle-up"></i>
<i data-fa-symbol="angle-right" class="fa-regular fa-angle-right"></i>
<i data-fa-symbol="angle-down" class="fa-regular fa-angle-down"></i>
<i data-fa-symbol="angle-left" class="fa-regular fa-angle-left"></i>
<i data-fa-symbol="arrow-up" class="fa-regular fa-arrow-up"></i>
