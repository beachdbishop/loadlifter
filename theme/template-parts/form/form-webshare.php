...
>
	...
	<div :class="!noOptionsAvailable() ? 'flex gap-2' : null" hidden :hidden="noOptionsAvailable()">
		<div class="relative" v-if="webShareSupported">
			<button class="inline-flex items-center justify-center px-5 py-3 font-bold no-underline border-2 rounded-lg text-orient-900 font-head shadow-neutral-900/10 hover:shadow-xl focus:outline-hidden focus:ring-3 focus:ring-3-orient-400/80 sm:w-auto lg:text-lg border-orient-900 hover:bg-orient-900 hover:text-white dark:border-orient-400 dark:text-orient-400 dark:hover:text-neutral-800 dark:hover:bg-orient-400" data-theme="ghost" @click="share">
		...
		<div class="relative" v-if="clipboardSupported">
			<button class="inline-flex items-center justify-center px-5 py-3 font-bold no-underline border-2 rounded-lg text-orient-900 font-head shadow-neutral-900/10 hover:shadow-xl focus:outline-hidden focus:ring-3 focus:ring-3-orient-400/80 sm:w-auto lg:text-lg border-orient-900 hover:bg-orient-900 hover:text-white dark:border-orient-400 dark:text-orient-400 dark:hover:text-neutral-800 dark:hover:bg-orient-400" data-theme="ghost" @click="copyLink">
