			...
			<div class="px-1 md:container md:mx-auto md:px-0">
				...
				<div class="entry-content not-prose">
					...
					<section class="container p-2 mx-auto mb-8 bg-white md:p-4 lg:p-8 md:flex md:gap-4 lg:gap-8 rounded-xl lg:p-16 lg:mb-16">
						...
						<div class="md:flex md:flex-wrap md:space-x-4 md:w-1/2 lg:space-x-8 lg:w-3/4">

							<div class="md:basis-1/4 md:grow">
							...
							<div class="md:basis-1/4 md:grow">
								<div class="h-full overflow-hidden border-2 rounded-lg bg-neutral-100 border-neutral-100">
									<div class="w-full bg-white"><a href="https://beachfleischman.com/resources/safesend-returns-guide/"><img class="mx-auto" src="https://beachfleischman.com/wp-content/uploads/2021/06/res__guide-safesend.png" alt="logo: SafeSend Returns" width="260" height="140"></a></div>
									<div class="p-6 ">
